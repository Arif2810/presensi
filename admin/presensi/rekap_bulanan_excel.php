...
$result = mysqli_query($connection, "SELECT presensi.*, pegawai.nama, pegawai.lokasi_presensi, pegawai.nip FROM presensi JOIN pegawai ON pegawai.id = presensi.id_pegawai WHERE DATE_FORMAT(tanggal_masuk, '%Y-%m') = '$tahun_bulan' ORDER BY tanggal_masuk DESC");
